if (room == rm_left) {
	if (global.filled <= 4) {
		if (global.bukoicecandycount >= 1) and (global.bukoicecandyava == true) {
			...
			x - sprite_xoffset + sprite_width, y - sprite_yoffset + sprite_height)) {
				if (mouse_check_button_pressed(mb_left)) {
					...
					global.filled += 1;
					global.bukoicecandycount -= 1;
					global.hasbukoicecandy = true;
					show_debug_message(string(global.bukoicecandycount));
