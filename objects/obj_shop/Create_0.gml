...
ds_list_add(items, ["Cone Rose", 270, spr_conerose]);
ds_list_add(items, ["Cone Vanilla", 270, spr_conerose]);
...
ds_list_add(items, ["Suka", 88, spr_suka]);
ds_list_add(items, ["Tiger Tagged", 95, spr_tigertag]);
ds_list_add(items, ["Toyo", 88, spr_toyo]);
